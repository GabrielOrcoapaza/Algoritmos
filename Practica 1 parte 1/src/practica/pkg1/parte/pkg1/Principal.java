...
public class Principal {
	public static void main(String[] args) {
		//PRIMERO HAREMOS LOS CASOS DE PRUEBAS CON LOS DATOS DE LA PRACTICA
		...
		//HAREMOS UN METODO PARA INGRESAR EL NUMERO DE RECTANGULOS
                //USAREMOS UN FOR
		for(int i=1;i<=n;i++){
	...
	public static void MostrarRectangulos(Rectangulo r1,Rectangulo r2){
		...
		if(Verificador.esJunto(r1, r2)==true){
			...
			System.out.println("Area de sobreposicion = "+ rectanguloSobre(r1, r2).calculoArea());
		}
